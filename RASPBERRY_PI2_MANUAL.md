...
目前已驗證版本是 `hermes-agent-iot 0.20.4.post1`。它已從公開 PyPI
...
```text
PyPI:       https://pypi.org/project/hermes-agent-iot/0.20.4.post1/
Tag:        iot-v0.20.4.post1
Commit:     dafa51137b212c4d1fe6328b03bbffea4db21a2b
Wheel:      hermes_agent_iot-0.20.4.post1-py3-none-any.whl
SHA-256:    48578319a051a07688a77e53010050296395a9c7e9be7ee4bde0e746965fa93d
Workflow:   https://github.com/matttest0080-prog/hermes-agent-iot/actions/runs/32437895667
```
